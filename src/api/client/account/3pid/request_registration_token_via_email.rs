...
use ruma::api::client::account::request_registration_token_via_email::{self, v3::Response};
...
///
/// Request a validation token to verify an email address during registration.
