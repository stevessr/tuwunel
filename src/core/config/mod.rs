...
fn default_server_name() -> OwnedServerName {
	ruma::owned_server_name!("localhost")
}

fn default_database_path() -> PathBuf {
	"/var/lib/tuwunel".to_owned().into()
}
...
fn default_oauth_subject_claim() -> String {
	"sub".to_owned()
}

fn default_oauth_displayname_claim() -> String {
	"name".to_owned()
}

fn default_client_sync_timeout_min() -> u64 {
	5000
}

fn default_client_sync_timeout_default() -> u64 {
	30000
}

fn default_client_sync_timeout_max() -> u64 {
	90000
}
...
fn default_one_time_key_limit() -> usize {
	256
}
